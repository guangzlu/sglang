...
class DecodeReqToTokenPool:
    ...
    def check_if_single_req_have_avaliable_token(self, indice):
        return self.available_token_id_for_reqs_start[indice] < self.available_token_id_for_reqs_end[indice]

    def get_free_buffer_from_preallocated(self, indice):
        return self.req_to_token[indice, self.available_token_id_for_reqs_start[indice]]
